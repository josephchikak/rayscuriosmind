          ...
          <div className="w-[100%]">
            {mainPic?.fields?.description === "video" ? (
              <video
                ...
                controls
              >
                <source src={`${mainPic?.fields?.file?.url}`} type="video/mp4" />
              </video>
            ) : (
              <img
          ...
          <div className="md:ml-5 mt-4 md:mt-0 h-auto max-w-full rounded-lg text-primary font-nudica flex flex-col gap-4 justify-between">
            <div>
              ...
              <div className="flex flex-col pt-2">
                {url !== undefined && (
                  <a href={url} target="_blank" className="hover:cursor-pointer text-background">
                    <span className="text-primary pb-5">Link</span>
                  </a>
                )}
                {code !== undefined && (
                  <a href={code} target="_blank" className="hover:cursor-pointer text-background">
