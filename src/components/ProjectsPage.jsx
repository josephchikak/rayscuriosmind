...
const ProjectsPage = () => {
  ...
  return (
    <div className="w-[100vw] h-[100%] text-text flex flex-col bg-background transition-all ease-in-out overflow-hidden">
      <main className="w-[100%] h-[100%] flex flex-col border-primary border-t-2 bg-text">
        ...
        {/* Navigation Tabs */}
        <div className="flex gap-4 px-10 pb-5 border-b-2 border-primary">
          <button
            onClick={() => setActiveTab('journal')}
            className={`px-4 py-2 font-inter font-semibold transition-all ${
              activeTab === 'journal'
