...
const Loading = () => {
    return(
      <div className="w-[100vw] h-[100vh] flex flex-col justify-center items-center font-gord bg-background gap-10">
        ...
        <p className="text-[1.5rem]">  loading exprience </p>
